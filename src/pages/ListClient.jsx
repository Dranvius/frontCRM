  ...
  const CrearUsu = async () => {
    const { value: formValues } = await Swal.fire({
      ...
      html:
        ...
        '<input id="swal-input3" className="swal2-input" placeholder="Nueva Cedula">' +
        '<input id="swal-input4" className="swal2-input" placeholder="Nuevo Correo Electronico">' +
        '<input id="swal-input5" className="swal2-input" placeholder="Nuevo Celular">' +
        '<input id="swal-input6" className="swal2-input" placeholder="Nuevo Estatus">',
